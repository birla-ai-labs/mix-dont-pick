...
from utils.predictors import MoraiPredictor
...
if __name__ == "__main__":
    for condition in CONDITIONS:
        for seed in seeds:
            model_path = TRAINED_MODELS_DIR / "moirai" / f"seed_{seed}" / condition
            ...
            evaluator = Evaluator(
                model_name=run_name,
                output_dir=TSTR_DIR / "moirai" / f"seed_{seed}",
                predictor=MoraiPredictor,
                predictor_args={
            ...
            evaluator.evaluate_datasets(save_forecasts=False, batch_size=None)
